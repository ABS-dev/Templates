...
|                        Curve Type / Shape                        |                   Sample File                  |                          Title                           |   RP Estimate    |
|:----------------------------------------------------------------:|:----------------------------------------------:|:--------------------------------------------------------:|:----------------:|
| Full dose response (3PL)                                         | [fulldose.sprx](fulldose.sprx)                 | Estimating Relative Potency<br>for Full Dose Curves      | `1 / RelPotPLA`  |
| Partial or Fully Linear/Straight line                            | [partiallylinear.sprx](partiallylinear.sprx)   | Estimating Relative Potency<br>for Partially Linear Data | `1 / RelPotPLA`  |
